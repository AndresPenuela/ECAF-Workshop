...
# 5. Crop Yield (Section 2)

# Yield (y) = 10x - 1300
if actual_rainfall < 450: 
    # If it is a dry year (< 450 mm), yield is highly dependent on stored water (net_water)
    yield_kg = max(0, (10 * actual_rainfall) - 1300)
else: 
    # In wet years, water is no longer the limiting factor
    yield_kg = 3200
